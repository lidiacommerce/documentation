...
On the Warehouses page, a list of all warehouses defined by sellers is displayed. As previously mentioned in the seller detail screens under the [Sellers](sellers.md) section in the Console left menu, warehouse definitions are made at the bottom of the Basic Information section for each seller. The primary purpose of defining warehouses is to ensure that the system knows from which outbound warehouse the goods will be shipped, in accordance with the general rules created by shipping profiles.
