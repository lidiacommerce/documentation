...
{% hint style="info" %}
When user creation, user management, or permission changes are required, these actions must be performed via **Lidia Marketplace Console →** [**Settings**](../../../lidia-console/lidia-console-user-guide/settings.md) **→ Authorization → Users**. In the Merchant Console, users are displayed only, and operational processes are carried out based on existing definitions.
{% endhint %}
