...
Marketplace Console → [Invoice Center](../../../lidia-console/lidia-console-user-guide/invoice-center.md) → Invoices page.
...
* [x] Clicking on the Transaction Link code in the list redirects the user to the Sales Management → [Delivery Management](../sales-management/delivery-management.md) page. From there, the details of the delivery associated with the invoice can be reviewed, allowing a holistic view of the delivery–invoice relationship.
